...
export default function Detail() {
  ...
  const message = `Olá ${incident.name}, estou entrando em contato, pois gostaria de ajudar no caso "${incident.title}" com o valor de: ${incidentValueFormated}.`;
  ...
  function sendMail() {
    MailComposer.composeAsync({
      ...
      recipients: ['morgannicholson1371@gmail.com'],
      body: message
    });
  }
